...
% ── tcolorbox Styles ─────────────────────────────────────────
% NOTE: breakable is intentionally omitted — it conflicts with XePersian bidi.
% NOTE: simple boxes use standard skin (no enhanced) to avoid TikZ/bidi conflicts.
% NOTE: parbox=false on all boxes prevents \parbox vs bidi direction clash.
...
% Principle box — needs enhanced for attach boxed title
...
% Article / Band box — needs enhanced for attach boxed title + borderline west
...
% Quote / blockquote — needs enhanced for borderline west
...
تمام جلسات و تصمیمات شورا علنی است. هیچ تصمیمی با اکثریت کمتر از \lr{$\frac{2}{3}$} اعضا اتخاذ نمی‌شود.
\end{bandbox}
