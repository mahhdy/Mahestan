...
% Disable problematic macros when hyperref writes PDF strings (bookmarks/TOC)
\pdfstringdefDisableCommands{% 
  % the \persian command enters font settings and causes missing-number errors
  \def\persian#1{#1}%
  \def\lr#1{#1}%
  \def\rl#1{#1}%
}
...
% ── Headers & Footers ───────────────────────────────────────
% Adjust headheight to satisfy fancyhdr warning and avoid overfull heads
\setlength{\headheight}{24pt} % FIXED: increased per fancyhdr recommendation
\pagestyle{fancy}
\fancyhf{}
...
% ============================================================
\begin{document}
% \SepMark is a bidi separator used in archives; not needed here and
% caused font-setting errors at chapter breaks. removed. % FIXED: removed unknown command
