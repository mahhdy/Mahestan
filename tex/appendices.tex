...
\node[
  rectangle, rounded corners=6pt,
  draw=MahestanRed, fill=DangerBg,
  text width=3cm, inner sep=8pt, font=\small
...
\node[
  rectangle, rounded corners=8pt,
  draw=MahestanPurple, fill=MahestanLightPurple,
  text width=3cm, inner sep=10pt, font=\bfseries\small
] (center5) {
...
\node[mahbox=MahestanBlue, above left=2cm and 1cm of center5] (q1) {
...
\node[mahbox=MahestanRed, above right =2cm and 1cm of center5] (q2) {
