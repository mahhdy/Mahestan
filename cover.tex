...
\begin{summarybox}
    ...
    طبیعی است، دپر مقاطعی از این دست، ملت‌ها با یک دوگانه‌ی مهم و اساسی روبرو هستند، آیا باید به نسل‌های آتی حق تعیین سرنوشت بدهند و آزادی انتخاب آن‌ها را محترم بشمارند؟ یعنی کمتر از اصول و قواعد تخلف ناپذیر استفاده کنند؟ (با توجه به این مهم که اصول تخلف ناپذیر در حول و حوش خود، نهادهایی و روابط قدرتی شکل خواهند داد که تغییر آن جز با خشونت و درگیری میسر شدنی نیست!) یا باید بر اساس تجاربی که کسب کرده‌اند و بر اساس ضرورت‌هایی که وجود دارند، یک نقشه‌ی راه محکم و بنیادی اصولی برای آیندگان به یادگار بگذارند، چرا که ممکن است هیجاناتی و یا توهماتی منجر به شکست فاجعه‌باری شود که هر آنچه برای آن زحمت کشیده شده است در خلال آن زایل شود! 
    آیا تعیین اصول تخلف ناپذیر و یا سخت برای تغییر، تعیین تکلیف و پدرسالاری برای آیندگان است و یا یک تصمیم هوشسمندانه که از رواداری و آزادی و تکثر محافظت خواهد کرد؟ 
...
\begin{figure}[!htb]
\centering
\includegraphics[width=\textwidth, keepaspectratio]{yes-no.png}
\end{figure}
